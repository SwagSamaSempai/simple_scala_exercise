...
object Main extends App {
    ...
    def question_1(flights: ArrayBuffer[Array[String]]): Array[Array[Int]] = {
    ...
    def question_2(flights: ArrayBuffer[Array[String]], passengers: Map[Int, Array[String]]): Array[Array[String]] = {
    ...
    def question_3(flights: ArrayBuffer[Array[String]], nbr_passengers: Int): Array[Array[Int]] = {
        ...
        var current_index = 0
        var next_index = 0
        for (id <- Range(1, nbr_passengers + 1, 1)) {
